...
function App() {
  ...
  const loveMessages = [
    "เค้ารักเธอ",
    "เค้ารักเธอที่สุดในโลก(ของเค้าเอง)",
    "Happy birthday to the one Who stole my heart !",
    "ขอให้เธอไม่ปวดหลังตลอดไป",
    "คิดไม่ออกละ คิดถึงแต่เธอ",
    "เค้าจาไม่ร้องให้แงแงให้เธอไม่สบายใจแล้วค่ะ",
    "เบบี๋คนเก่งโตแย้ว ต้องม่ายดื้อด้วยนะคะ",
    "เค้าขอให้เธอมีความสุขม้ากมากเลยนะคะ",
    "ขอให้เธอสบายใจที่จะอยู่กับเค้าแบบนี้ตลอดไปนะคะ",
    "คนเก่งของเค้าโตปายด้วยกันน้ะ",
    "สุขสันต์วันเกิดเธอนะคะ",
    "ขอบคุณที่เป็นคนที่น่ารักมากๆนะคะ",
    "ขอบคุณนะคะที่เราได้มาเจอกัน",
    "เค้าดีใจที่ได้รู้จักเธอนะคะ",
  ];
